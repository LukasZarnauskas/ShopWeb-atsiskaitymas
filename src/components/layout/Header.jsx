...
console.log(open);
  return (
   ...
   <div className='m-4 flex justify-between items-center border-b border-gray-100'>
    <Link to={'/'}> <div className='flex'> <img className='mb-1' src="../../../public/img/58px.svg" alt="logo" /> <h3 className='ml-2 hover:text-gray-500 hidden lg:block'>SHOPSWEB</h3></div></Link>
